...
public record HyperBookData(
    ...
    public HyperBookData(ResourceLocation dimensionId, String dimensionName) {
        this(dimensionId, dimensionName, null, null, null, null, null, null, null);
    }

    public HyperBookData(ResourceLocation dimensionId, String dimensionName, @Nullable Integer labelColor) {
        this(dimensionId, dimensionName, null, labelColor, null, null, null, null, null);
    }

    public HyperBookData(ResourceLocation dimensionId, String dimensionName, @Nullable UUID creatorId, @Nullable Integer labelColor) {
        this(dimensionId, dimensionName, creatorId, labelColor, null, null, null, null, null);
    }
    ...
    public HyperBookData(ResourceLocation dimensionId, String dimensionName, Vec3 targetPosition, float targetYRot, float targetXRot) {
        this(dimensionId, dimensionName, null, null, targetPosition.x, targetPosition.y, targetPosition.z, targetYRot, targetXRot);
    }
    ...
    public HyperBookData(ResourceLocation dimensionId, String dimensionName, @Nullable Integer labelColor, Vec3 targetPosition, float targetYRot, float targetXRot) {
        this(dimensionId, dimensionName, null, labelColor, targetPosition.x, targetPosition.y, targetPosition.z, targetYRot, targetXRot);
    }

    public HyperBookData(ResourceLocation dimensionId, String dimensionName, @Nullable UUID creatorId, @Nullable Integer labelColor, Vec3 targetPosition, float targetYRot, float targetXRot) {
        this(dimensionId, dimensionName, creatorId, labelColor, targetPosition.x, targetPosition.y, targetPosition.z, targetYRot, targetXRot);
    }
    ...
    public CompoundTag toTag() {
        ...
        if (this.creatorId != null) {
            tag.putUUID(CREATOR_TAG, this.creatorId);
        }
    ...
    public static Optional<HyperBookData> fromTag(CompoundTag tag) {
        ...
        UUID creatorId = tag.hasUUID(CREATOR_TAG) ? tag.getUUID(CREATOR_TAG) : null;
        ...
        return Optional.of(new HyperBookData(dimensionId, dimensionName, creatorId, labelColor, targetX, targetY, targetZ, targetYRot, targetXRot));
    }
}
